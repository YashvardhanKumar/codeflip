      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 lg:py-32 flex flex-col items-center justify-center text-center px-4">
          ...
          >
            ...
            >
              CodeFlip is where developers sharpen their skills, compete in
            ...
            >
              <Link href="/problems">
                <Button
                  size="lg"
                  className="w-full sm:w-auto text-lg px-8 bg-primary hover:bg-primary/90 text-white shadow-xl shadow-primary/20 transition-all hover:scale-105 active:scale-95"
                >
                  Get Started
              ...
              {!user && (
                <Link href="/signup">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto text-lg px-8 border-slate-200 dark:border-surface-border transition-all hover:bg-slate-50 dark:hover:bg-surface-border"
                  >
                    Join Now
                  </Button>
                </Link>
        ...
        <section className="py-20 relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-lg text-slate-600 dark:text-text-secondary mb-10">
              Join our community of over 50,000 developers and start improving
              your skills today.
            </p>
