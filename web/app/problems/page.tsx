          ...
          <main className="flex-1 min-w-0 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-2 self-end sm:self-auto">
                <select className="form-select bg-slate-100 dark:bg-surface-border border-none text-slate-700 dark:text-text-secondary text-sm rounded-lg py-2.5 pl-3 pr-8 focus:ring-2 focus:ring-primary/50 cursor-pointer transition-all outline-hidden">
