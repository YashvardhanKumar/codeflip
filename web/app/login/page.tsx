...
export default function LoginPage() {
  ...
  const handleSocialLogin = (provider: 'google-oauth2' | 'github') => {
    ...
    toast.info(`${provider.charAt(0).toUpperCase() + provider.slice(1)} login coming soon! Configuration required.`);
  };
      ...
      <div className="hidden lg:flex flex-1 relative items-center justify-center bg-slate-900 overflow-hidden">
        ...
        >
          ...
          <div className="space-y-4">
            <h2 className="text-4xl font-bold text-white tracking-tight">Ready for the race?</h2>
            <p className="text-slate-400 text-lg max-w-md mx-auto">
              Join the elite league of developers. Compete, solve, and outpace the rest.
            </p>
          </div>
          
          <div className="grid grid-cols-2 gap-4 text-left">
            {[
              { icon: <Zap size={18} />, title: "Real-time", desc: "Live competition" },
              { icon: <ShieldCheck size={18} />, title: "Secure", desc: "Sandbox isolation" },
            ].map((item, i) => (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button 
                ...
                disabled={isLoading}
              >
                {isLoading ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : "Sign In to Race"}
              </Button>
            </form>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-slate-50 dark:bg-[#0a0a0b] px-2 text-slate-500">Or continue with</span>
              </div>
            </div>
